...
func findItemById(id string, items []Item) (item *Item) {
...
func PerformAdd(fileName string, itemStr string, writer io.Writer) error {
	var item Item
	...
	foundItem := findItemById(item.Id, items)
	if foundItem != nil {
...
func Perform(args Arguments, writer io.Writer) error {
	...
	case AddOperation:
		...
		return PerformAdd(fileName, args[ItemFlag], writer)
	...
	case RemoveOperation:
		...
		return PerformRemove(fileName, args[IdFlag], writer)
	default:
